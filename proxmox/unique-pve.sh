...
# Proxmox VE 9.x
rrd_node_old="/var/lib/rrdcached/db/pve-node-9.0/$old_hostname"
rrd_node_new="/var/lib/rrdcached/db/pve-node-9.0/$new_hostname"
rrd_storage_old="/var/lib/rrdcached/db/pve-storage-9.0/$old_hostname"
rrd_storage_new="/var/lib/rrdcached/db/pve-storage-9.0/$new_hostname"
# Proxmox VE 8.x
